...
| **Grupo** | Aluno 2 (RM000001), Aluno Product Owner (RM000000), Aluno 3 (RM000002), Aluno 4 (RM000003) |
...
│   └── README.md
├── ml/
│   ├── AlunoProductOwner_RM000000_fase3_cap10.ipynb
...
2. Conectar em `oracle.fiap.com.br:1521/ORCL` com usuário `RM000000`.
...
# 3. Notebook ML
jupyter notebook ml/AlunoProductOwner_RM000000_fase3_cap10.ipynb
```
...
**Aluno 2, Aluno Product Owner, Aluno 3, Aluno 4.**

Coordenação técnica e documentação: Aluno Product Owner (workflow IA-assistido com
